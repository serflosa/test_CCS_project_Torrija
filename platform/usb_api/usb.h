...
extern __no_init uint8_t  abIEP0Buffer[];
extern __no_init uint8_t  abOEP0Buffer[];
extern __no_init uint8_t  pbXBufferAddressEp1[];
extern __no_init uint8_t  pbYBufferAddressEp1[];
extern __no_init uint8_t  pbXBufferAddressEp81[];
extern __no_init uint8_t  pbYBufferAddressEp81[];
extern __no_init uint8_t  pbXBufferAddressEp2[];
extern __no_init uint8_t  pbYBufferAddressEp2[];
extern __no_init uint8_t  pbXBufferAddressEp82[];
extern __no_init uint8_t  pbYBufferAddressEp82[];
