...
//WATCHOUT: DEPENDANT OF CRYSTAL FREQ (MCLK frequency 32MHz/4 = 8MHz)
...
#define USB_XT_FREQ       USBPLL_SETCLK_32_0 // Indicates the freq of the crystal on the oscillator indicated by USB_PLL_XT
...
#define USB_DMA_TX   0xFF    // Set to 0xFF if no DMA channel will be used 0..7 for selected DMA channel
#define USB_DMA_RX   0xFF   // Set to 0xFF if no DMA channel will be used 0..7 for selected DMA channel
...
extern uint8_t const abromConfigurationDescriptorGroup[SIZEOF_CONFIGURATION_DESCRIPTOR];
